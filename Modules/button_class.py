...
class RectButton(Button):
    ...
    def draw(self):
        ...
        if self.butt_position[0] <= self.cursor_pos[0] <= self.butt_position[0]+self.butt_area[0] and self.butt_position[1] <= self.cursor_pos[1] <= self.butt_position[1]+self.butt_area[1]:
...
class CircButton(Button):
    ...
    def draw(self):
        ...
        if self.butt_position[0] <= self.cursor_pos[0] <= self.butt_position[0]+self.butt_area and self.butt_position[1] <= self.cursor_pos[1] <= self.butt_position[1]+self.butt_area:
